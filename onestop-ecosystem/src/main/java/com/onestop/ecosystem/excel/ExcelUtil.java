...
public class ExcelUtil {
    ...
    public static List<Object> readExcel(String path, BaseRowModel rowModel, String[] sheetNames) {
        List<String> sheetList = Arrays.asList(sheetNames);
        ...
        if (file.exists()) {
            try {
                ...
                for (Sheet sheet : excelReader.getSheets()) {
                    ...
                    //读取指定名称的sheet
                    if (sheetList.contains(sheet.getSheetName())) {
                        excelReader.read();
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        ReadSheet readSheet = EasyExcel.readSheet("生物丰度指数").build();
        ExcelReader excelReader =
                EasyExcel.read("E:/EI--2018.xlsx", VegetationalCover.class, new VegetationalCoverListener("2018")).build();
